...
const config: Config = {
  ...
  // Vercel root URL
  url: 'https://your-vercel-frontend-url.vercel.app', // <-- Update with your Vercel URL after deploy
  ...
  // GitHub pages config (optional for Vercel)
  organizationName: '<YOUR_GITHUB_USERNAME_OR_ORG>',
  projectName: 'Bookplus_Chatbot',
